...
public class EditedCompoundMutator implements ScriptMutator {
  // The ordering of mutators matters
  private final List<ScriptMutator> mutators = new ArrayList<>();

  public EditedCompoundMutator(String baseUrl) {
    initializeMutators(baseUrl);
  }

  private void initializeMutators(String baseUrl){
